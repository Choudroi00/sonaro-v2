...
const envSchema = z.object({
  EXPO_PUBLIC_APP_ENV: z.enum(['development', 'staging', 'preview', 'production']),
...
const BUNDLE_IDS = {
  development: 'com.sonaro.development',
  staging: 'com.sonaro.staging',
  preview: 'com.sonaro.preview',
  production: 'com.sonaro',
} as const;
...
const SCHEMES = {
  development: 'sonaro',
  staging: 'sonaro.staging',
  preview: 'sonaro.preview',
  production: 'sonaro',
} as const;
